...
extern uint64 sys_trace(void);//Declaring functions
extern uint64 sys_sysinfo(void);//Declaring functions
...
[SYS_mkdir]   sys_mkdir,
[SYS_close]   sys_close,
[SYS_trace]   sys_trace, //This array provides a lookup table for the different system calls
